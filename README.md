...
## Key Features
  ...
  Auto Rename       Timestamps, numbers, keep     Too many files?
  Safe Mode         Copy by default, conflict      Protect your files
...
MIT License - Free to use and modifyCreated with Claude Code
